...
import type { ProductsPageProps, ProductFeature, UseCase, IntegrationStep, ConnectedBank } from './ProductsPage.interface';
...
export function ProductsPage({ 
  ...
  className,
  style,
  'data-testid': dataTestId = 'products-page'
}: ProductsPageProps) {
  const weekendSettlementFeatures: ProductFeature[] = [
    {
  ...
  const baasFeatures: ProductFeature[] = [
    {
